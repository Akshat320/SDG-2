...
if(gameState === 10 && quizState !== 4)
{
  ...
  fill("pink");
  textSize(30);
  text("Quiz Score: "+ quizScore,100, 100);
}
...
if(mousePressedOver(qo4) && quizState === 1)
{
  ...
  qo3.addImage(q2q3);
  qo4.addImage(q2q4);
  question1.addImage(question2Img);
  quizScore = quizScore+10;
}
else if(mousePressedOver(qo1) || mousePressedOver(qo2) || mousePressedOver(qo3) && quizState === 1)
{
 quizState = 2;
...
if(mousePressedOver(qo2) && quizState === 2)
{
  ...
  qo3.addImage(q3q3);
  qo4.addImage(q3q4);
  question1.addImage(question3Img);
}else if(mousePressedOver(qo1) || mousePressedOver(qo4) || mousePressedOver(qo3) && quizState === 2)
{
 quizState = 3;
 qo1.addImage(q3q1);
 qo2.addImage(q3q2);
...
if(mousePressedOver(qo2) && quizState === 2 && quizScore === 10)
{
  quizScore = 20;
}else{
  quizScore = 10;
...
if(quizState === 3 && mousePressedOver(qo1) && quizScore === 0)
{
  
  quizScore = 10;
  quizState = 4;
}
if(quizState === 3 && mousePressedOver(qo1) && quizScore === 10)
{
  
  quizScore = 20;
  quizState = 4;
}
if(quizState === 3 && mousePressedOver(qo1) && quizScore === 20)
{
...
if(quizState === 3 && mousePressedOver(qo2) || mousePressedOver(qo3) || mousePressedOver(qo4))
{

  quizState = 4;
}

if(quizState === 4 && gameState === 10)
{
  ...
  fill("red");
  textSize(40);
  text("Your Score", 330, 350);
  text(quizScore, 380, 400);
  back.visible = true;
  back.x = 400;
  back.y = 460;
}

if(gameState === 10 && quizState === 4 && mousePressedOver(back))
{
